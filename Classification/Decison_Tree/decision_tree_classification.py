...
- Capable of handling both binary and multi-class classification problems.
- Performs well with small to medium-sized datasets.

Cons of Decision Tree Classification:
- Prone to overfitting, especially with deep trees or complex datasets.
- Sensitive to small changes in the data, which can result in entirely different tree structures.
- Less effective for large datasets and when the data has many irrelevant features.
"""
...
dataset = pd.read_csv('./Classification/Decison_Tree/Social_Network_Ads.csv')
